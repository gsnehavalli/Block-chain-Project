...
<% 
    ...
    try{
		    ...
		    String query3 ="insert into agent_transfer values('"+name+"','"+bank+"','"+facno+"','"+tacno+"','"+amount+"','"+status1+"','"+dt+"','"+fwhom+"','"+aname+"')";
											int k=st3.executeUpdate(query3);
											if(k>0)
											{
											%>
										
										<h2> Your Request Sent To Agent Successfully!!! Pls Wait for Some Time</h2>
