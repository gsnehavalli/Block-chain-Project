...
<head>
<title>Auditor_Register status</title>
      ...
      <div class="article">
        ...
        <%
			...
			else if(!bank.equals("Select"))
			{
					...
					if ( rs2.next() )
					{
								...
								String query1="select * from auditor  where username='"+uname+"' and bank='"+bank+"'"; 
        ...
        <%
								...
								else
								{
					   					...
					   					PreparedStatement ps=connection.prepareStatement("insert into auditor(bank,username,password,email,mobile,address,dob,gender,loginstatus,transferstatus,image,thumbimage,thumbname,ac_creation_status,privatekey) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
									ps.setString(1,bank);
