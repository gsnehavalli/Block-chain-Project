...
<head>
<title>Via agent monet Transctions</title>
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <form id="form1" name="form1" method="post" action="">
			...
			<p align="center" class="style17"><span class="style15"><span class="style18"><a href="U_DepositMoney1.jsp"> 1. Deposit Amount</a></span></span></p>
