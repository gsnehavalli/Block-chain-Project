              ...
              <table width="570" border="0" align="left" cellpadding="2" cellspacing="2">
                ...
                <tr>
                  <td height="46" align="center" valign="middle"><span class="style35">
                    <label for="label"> </label>
                      ...
                      <label for="label">
                      <div align="center"><span class="style35"><strong>Vendor Name (required)</strong></span></div>
                    </label>
                      <span class="style35">
                ...
                <tr>
                  ...
                  <td><input name="imageField" type="submit"  class="LOGIN" id="imageField" value="Login" />
                      <span class="style38">New Vendor?</span><span class="style10"><a href="AdminRegister.jsp" class="style30"> Register </a></span></td>
                </tr>
              </table>
              <div class="clr"></div>
            </div>
